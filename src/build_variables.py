...
VARIABLES = {
    ...
    'panc_with_pain': ('+pancreatitis', '+abdominal_pain'),
    'panc_with_radiating_to_back_pain': ('+pancreatitis', '+abdominal_pain_RADIATING_TO_BACK'),
    'panc_with_abdominal_pain': ('+pancreatitis', '+abdominal_pain_PAIN'),
    ...
    'panc_with_sudden_onset_pain': ('+pancreatitis', '+abdominal_pain_SUDDEN_ONSET'),
    'acute_panc_with_sudden_onset_pain': ('+pancreatitis_ACUTE', '+abdominal_pain_SUDDEN_ONSET'),
    ...
    'panc_with_recency': ('+pancreatitis', '+abdominal_pain_RECENT'),
