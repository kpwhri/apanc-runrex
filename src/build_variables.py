...
VARIABLES = {
    ...
    'apanc_with_competing_dx': ('+pancreatitis_ACUTE', '+competing_dx', '-competing_dx_NEGATIVE'),
    ...
    'apanc_consistent': ('+pancreatitis_ACUTE', '+pancreatitis_CONSISTENT_WITH', '+is_radiology'),
    'panc_consistent': ('+pancreatitis', '+pancreatitis_CONSISTENT_WITH', '+is_radiology'),
